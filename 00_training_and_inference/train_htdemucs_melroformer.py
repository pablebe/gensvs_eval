...
#TODO: start with incorporating stft and istft for MaskingModel Class mit stft specs from melbandroformer #1

import os
os.environ["WANDB_API_KEY"] = 'eecdd46f7d6d52ecaf6dff06f4a9f4025eff5f1a'
os.environ["CUDA_VISIBLE_DEVICES"] = "2"#,2"#,1,2"#,1,2,3,4,5"
...
#          wandb.define_metric("*", "epoch")
     ...
     dummy_input = torch.randn(1,2,1*args.sr).to(model.device)
     model.eval()
     macs, params = profile(model, inputs=(dummy_input, ))
     print("THOP model summary for: masked-based "+str(args.backbone))
     ...
     # Train modelfrom thop import profile
