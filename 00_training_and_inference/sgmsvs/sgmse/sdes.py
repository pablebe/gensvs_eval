...
class OUVESDE(SDE):
    ...
    def add_argparse_args(parser):
        parser.add_argument("--theta", type=float, default=2, help="The constant stiffness of the Ornstein-Uhlenbeck process. 1.5 by default.")
        parser.add_argument("--sigma-min", type=float, default=0.1, help="The minimum sigma to use. 0.05 by default.")
        parser.add_argument("--sigma-max", type=float, default=1, help="The maximum sigma to use. 0.5 by default.")
