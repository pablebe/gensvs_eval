...
os.environ["CUDA_VISIBLE_DEVICES"] = "2"#"0,1,2,3"#,2,3"#"0,1,2,3,4,5"
...
def input_constructor(input_res):
    # input_res could be ((3, 224, 224), (1, 28, 28)), for example
...
#          wandb.define_metric("*", "epoch")
     ...
     # model.eval()
     # macs, params = profile(model.dnn, inputs=(dummy_input, dummy_input_2))
     # print("THOP model summary for: generative "+str(args.backbone))
     # print(f"MACs/s: {macs / 1e9/args.duration:.2f} B")
